...
## Assigning Variables
scaled_data = "/home/data/Dropbox (Genomic Expression)/GEx Bioinformatics/12. OneRNA Secondary Pipeline/Sanmati Normalization Experiments/Lymph_Bcell_Normals/B_cells_secondary_analysis/B_cells-scaled.csv"
gene_states = "/home/data/Dropbox (Genomic Expression)/GEx Bioinformatics/12. OneRNA Secondary Pipeline/Sanmati Normalization Experiments/Lymph_Bcell_Normals/B_cells_secondary_analysis/B_cells-gene_states.csv"
gene_panel = "/home/data/Dropbox (Genomic Expression)/GEx Bioinformatics/8. OneRNA Report/20231017 Gene Panel List Text OneRNAdb data and Report Table.xlsx"
panel_name = "Metabolic Pathways"
normal_count = 15
...
png("apoptosis_very_high_and_high.png", width = 1200, height = 800)
## Generating Boxplots
...
legend("topleft", c("Normal_Boxplot","Normal_Outlier", tumor_sample), col = c("lightgray","yellow", "brown1"), pch = 15, cex = 1)
...
axis(1, 1:ncol(An), colnames(An), cex.axis =1.0,font = 2,xaxt = "n")
mtext(side = 1, text = colnames(An), at= 1:ncol(An), col = col, line = 0.5, font = 1)
dev.off()
